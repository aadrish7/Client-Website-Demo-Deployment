...
// export const handler: Schema["bulkCreateEmployees"]["functionHandler"] = async (
//   event,
//   context
// ) => {
...
//     const user: any = colonStringToObject(
//       employeeArray[i] ? String(employeeArray[i]) : ""
//     );
//     try {
...
//     throw new Error(
//       `First name and last name are required fields. Invalid input: ${input}`
//     );
//   }
